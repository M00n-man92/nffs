...
export default function ProfileMaterial() {
  ...
  const renderModal = () => {
    return (<>
      ...
      >
        {changeModal === "update" ? <UpdateMaterial setOpenModal={setOpenModal} openModal={openModal} product={item}/> :

          <CreateMaterial setOpenModal={setOpenModal} openModal={openModal} />
        }
      </Modal>
    </>
    )
